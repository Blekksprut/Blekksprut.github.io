...
// node_modules/iso-language-converter/iso.json
var require_iso = __commonJS({
  "node_modules/iso-language-converter/iso.json"(exports, module) {
    module.exports = [{
      "ISO 639-2/5": "aar",
      "ISO 639-3": "aar",
      "ISO 639-1": "aa",
...
// node_modules/iso-language-converter/index.es5.js
var require_index_es5 = __commonJS({
  "node_modules/iso-language-converter/index.es5.js"(exports, module) {
    Object.defineProperty(exports, "__esModule", {
      value: true
    });
    exports.default = isoLanguageConverter;
    var _iso = require_iso();
    var _iso2 = _interopRequireDefault(_iso);
    function _interopRequireDefault(obj) {
      return obj && obj.__esModule ? obj : { default: obj };
    }
    function isoLanguageConverter(input) {
      var options = arguments.length <= 1 || arguments[1] === void 0 ? {} : arguments[1];
      if (!input || typeof input != "string") throw new Error("isoConv requires a string as first argument");
      var isoFrom = options.from || (input.length == 2 ? 1 : input.length == 3 ? 5 : "label");
      if (isoFrom == "script") {
        throw new Error('"script" is not a valid value for the "from" option');
      }
      var isoTo = options.to || (isoFrom == "label" ? 1 : "label");
      var field = code2field(isoTo);
      if (!field) throw new Error('"to" option invalid');
      var result = find(input, isoFrom);
      if (!result) return null;
      var str = result[field];
    ...
    function find(input, isoV) {
      var field = code2field(isoV);
      if (!field) throw new Error('"from" option invalid');
      return _iso2.default.find(function(item) {
...
export default require_index_es5();
//# sourceMappingURL=iso-language-converter_index__es5.js.map
